...
// #pragma newdecls required (removed for morecolors.inc compat)
...
public void OnPluginStart()
{
    ...
    // Init database BEFORE touching players, so db handle is valid for OnClientPostAdminCheck.
    if (!g_bNoStats)
    {
        PrepareSQL();
    }
